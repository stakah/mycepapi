...
2.1.1 Variaveis de ambiente para desenvolvimento no IntelliJ
...
2.1.2.1 Importar o projeto como Maven
...
2.1.2.2 Configurar o projeto para utilizar Java 11
...
2.1.2.3 Configurar os parâmetros de execução do projeto
...
de execução criada. Clique em `Modify Options` e marque a opção
...
3.1. Parando os containers do Docker Compose:
...
3.3. Executando o projeto como container Docker
